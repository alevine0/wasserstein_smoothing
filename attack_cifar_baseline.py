...
testloader = torch.utils.data.DataLoader(testset, batch_size=100, shuffle=False, num_workers=2, sampler=torch.utils.data.sampler.SubsetRandomSampler(test_indices))
